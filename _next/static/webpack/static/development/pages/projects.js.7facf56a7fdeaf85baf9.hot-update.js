...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(_default, [{
    ...
    value: function scrollScreenshots(screenshots) {
      var marginTop = screenshots.style.marginTop;
      var clientHeight = screenshots.children[0].clientHeight;
      marginTop = _babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_0___default()(marginTop) - 1;
      if (marginTop * -1 >= clientHeight / 2) marginTop = 0;
      screenshots.style.marginTop = marginTop + 'px';
    }
  }, {
    key: "getProjects",
        ...
        for (var _iterator2 = _babel_runtime_corejs2_core_js_get_iterator__WEBPACK_IMPORTED_MODULE_1___default()(_projects_js__WEBPACK_IMPORTED_MODULE_10__["default"]), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          ...
          try {
            for (var _iterator3 = _babel_runtime_corejs2_core_js_get_iterator__WEBPACK_IMPORTED_MODULE_1___default()(project.screenshots), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
              ...
              screenshots.push(react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("div", {
                key: screenshot,
          ...
          try {
            for (var _iterator4 = _babel_runtime_corejs2_core_js_get_iterator__WEBPACK_IMPORTED_MODULE_1___default()(project.screenshots), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
          ...
          try {
            for (var _iterator5 = _babel_runtime_corejs2_core_js_get_iterator__WEBPACK_IMPORTED_MODULE_1___default()(project.links), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
              var link = _step5.value;
              links.push(react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("a", {
                key: link.url,
                type: link.type,
                target: "_blank",
          ...
          projects.push(react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("div", {
            ...
            __self: this
          }, project.title), links), react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("p", {
...
//# sourceMappingURL=projects.js.7facf56a7fdeaf85baf9.hot-update.js.map