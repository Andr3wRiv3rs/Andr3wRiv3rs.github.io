...
var Description = function Description(props) {
  ...
  description = description.split(/(?!\[[^\[\]]+)\s(?![^\[\]]+\])/g);

  for (var i in description) {
    description[i] += ' ';
    var linkExec = /(\[[^\[\]]+\])(\([^\(\)]+\))/g.exec(description);
    if (linkExec) description[i] = react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("a", {
      key: linkExec[2],
      href: linkExec[2].replace(/(\(|\))/g, ''),
      __source: {
        fileName: _jsxFileName,
        lineNumber: 66
      },
      __self: this
    }, linkExec[1].replace(/(\[|\])/g, ''));
  }
...
//# sourceMappingURL=projects.js.9ed7abb1c82bb8d83db7.hot-update.js.map