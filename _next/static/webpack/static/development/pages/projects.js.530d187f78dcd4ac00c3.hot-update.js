    ...
    value: function scrollScreenshots(screenshots) {
      try {
        var _screenshots$children = screenshots.children[0],
            style = _screenshots$children.style,
        ...
        if (marginTop * -1 >= clientHeight / 2) screenshots.children[0].style.marginTop = '-600px';
        console.log(screenshots.children[0].style.marginTop);
      } catch (err) {
        console.error(err);
      }
    }
...
//# sourceMappingURL=projects.js.530d187f78dcd4ac00c3.hot-update.js.map