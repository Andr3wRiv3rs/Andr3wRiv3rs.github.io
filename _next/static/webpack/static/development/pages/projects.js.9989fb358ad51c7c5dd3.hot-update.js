      ...
      try {
        for (var _iterator2 = _babel_runtime_corejs2_core_js_get_iterator__WEBPACK_IMPORTED_MODULE_1___default()(_projects_js__WEBPACK_IMPORTED_MODULE_10__["default"]), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          ...
          projects.push(react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("div", {
            ...
            style: {
              backgroundImage: "url(/static/projects/".concat(_project.id, "/").concat(_project.id, ".png)")
            },
            __source: {
              fileName: _jsxFileName,
              lineNumber: 44
            ...
            __self: this
          }, _project.title), _project.links ? _project.links.map(function (link) {
            ...
            __self: this
          }, _project.handles ? _project.handles.map(function (handle) {
            return react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("a", {
              key: handle.value,
              type: handle.type,
              target: "_blank",
            ...
            __self: this
          }, _project.description)), react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("div", {
            ...
            __self: this
          }, _project.screenshots ? _project.screenshots.map(function (screenshot) {
            return react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(Screenshot, {
...
//# sourceMappingURL=projects.js.9989fb358ad51c7c5dd3.hot-update.js.map