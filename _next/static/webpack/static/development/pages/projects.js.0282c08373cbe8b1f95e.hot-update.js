...
var Description = function Description(props) {
  ...
  for (var i in description) {
    ...
    var _link = /(\[[^\[\]]+\])(\([^\(\)]+\))/g.exec(description);

    if (_link) description[i] = react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("a", {
      key: _link[2],
      className: _index_sass__WEBPACK_IMPORTED_MODULE_9___default.a.handle,
      href: _link[2].replace(/(\(|\))/g, ''),
      __source: {
        fileName: _jsxFileName,
        lineNumber: 67
      },
...
//# sourceMappingURL=projects.js.0282c08373cbe8b1f95e.hot-update.js.map