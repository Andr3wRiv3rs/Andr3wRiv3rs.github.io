  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(_default, [{
    ...
    value: function scrollScreenshots(screenshots) {
      try {
        ...
        var top = style.top;
        top = top || 0;
        top = _babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_0___default()(top) - 1;
        if (top * -1 >= clientHeight / 2) screenshots.children[0].style.top = top + 'px';
        console.log(screenshots.children[0].style.top = top + 'px');
      } catch (err) {
        console.error(err);
      }
    }
...
//# sourceMappingURL=projects.js.3dff3d26111757bd3620.hot-update.js.map